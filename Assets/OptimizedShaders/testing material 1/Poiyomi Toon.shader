Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/02d63d5b904d8cc4d85682228a56c740"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(1,0,0,1).rgb, (0.0 /*_ColorThemeIndex*/));
