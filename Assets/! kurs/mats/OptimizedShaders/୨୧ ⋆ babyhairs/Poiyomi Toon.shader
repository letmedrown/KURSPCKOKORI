Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/c8abafb396847ca4987ad9ada12aaabb"
{
	Properties
	{
		...
		_DecalBlendAlpha_E0ADA8E0ADA7E28B86babyhairs ("Alpha", Range(0, 1)) = 1
		...
		_DecalBlendAlpha1_E0ADA8E0ADA7E28B86babyhairs ("Alpha", Range(0, 1)) = 1
		...
		_DecalHueShift1_E0ADA8E0ADA7E28B86babyhairs ("Hue Shift", Range(0, 1)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DecalBlendAlpha_E0ADA8E0ADA7E28B86babyhairs;
			...
			float _DecalBlendAlpha1_E0ADA8E0ADA7E28B86babyhairs;
			float _DecalOverrideAlpha1;
			float _DecalHueShiftColorSpace1;
			float _DecalHueShiftEnabled1;
			float _DecalHueShift1_E0ADA8E0ADA7E28B86babyhairs;
			...
			struct PoiDecal
			{
				...
				float m_DecalBlendAlpha_E0ADA8E0ADA7E28B86babyhairs;
				...
				void Apply(inout float alphaOverride, inout float decalAlpha, inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
				{
					...
					float decalAlphaMixed = decalColor.a * saturate(m_DecalBlendAlpha_E0ADA8E0ADA7E28B86babyhairs + audioLinkDecalAlpha);
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal0.m_DecalBlendAlpha_E0ADA8E0ADA7E28B86babyhairs = _DecalBlendAlpha_E0ADA8E0ADA7E28B86babyhairs;
				...
				Decal1.m_DecalBlendAlpha_E0ADA8E0ADA7E28B86babyhairs = _DecalBlendAlpha1_E0ADA8E0ADA7E28B86babyhairs;
				...
				Decal1.m_DecalHueShift = _DecalHueShift1_E0ADA8E0ADA7E28B86babyhairs;
