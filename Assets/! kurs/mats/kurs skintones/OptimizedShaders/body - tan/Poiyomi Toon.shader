Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/99b34c51a7d8b0248be326d43c3185a8"
{
	Properties
	{
		...
		[Normal]_BumpMap ("Normal Map--{reference_properties:[_BumpMapPan, _BumpMapUV, _BumpScale_body2Dtan, _BumpMapStochastic]}", 2D) = "bump" { }
		...
		[HideInInspector]_BumpScale_body2Dtan ("Intensity", Range(0, 10)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), _BumpScale_body2Dtan);
				#else
