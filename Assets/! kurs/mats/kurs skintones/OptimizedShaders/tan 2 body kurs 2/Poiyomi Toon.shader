Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/f700889bbef2f2149a3e184ef8242938"
{
	Properties
	{
		...
		[Normal]_BumpMap ("Normal Map--{reference_properties:[_BumpMapPan, _BumpMapUV, _BumpScale_tan2bodykurs2, _BumpMapStochastic]}", 2D) = "bump" { }
		...
		[HideInInspector]_BumpScale_tan2bodykurs2 ("Intensity", Range(0, 10)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float2 _BumpMapPan;
			float _BumpMapUV;
			float _BumpScale_tan2bodykurs2;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(0.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), _BumpScale_tan2bodykurs2);
				#else
