Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/8e9c02407469ee54ea1d683193e8445f"
{
	Properties
	{
		...
		_DecalBlendAlpha2_face2Dtan ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DecalBlendAlpha2_face2Dtan;
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal2.m_DecalBlendAlpha = _DecalBlendAlpha2_face2Dtan;
