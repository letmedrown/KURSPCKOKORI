Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/ef5bb3bc6247f794fa537d49b0903c6c"
{
	Properties
	{
		...
		[Normal]_BumpMap ("Normal Map--{reference_properties:[_BumpMapPan, _BumpMapUV, _BumpScale_Lollipopdark2, _BumpMapStochastic]}", 2D) = "bump" { }
		...
		[HideInInspector]_BumpScale_Lollipopdark2 ("Intensity", Range(0, 10)) = 1
		...
		_DecalBlendAlpha1_Lollipopdark2 ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float2 _BumpMapPan;
			float _BumpMapUV;
			float _BumpScale_Lollipopdark2;
			...
			float _DecalBlendAlpha1_Lollipopdark2;
			...
			)
			{
				...
				float lineWidth = (0.0003 /*_LineWidth*/);
				#ifdef POI_AUDIOLINK
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal1.m_DecalColor = float4(0.0890862,0.07199804,0.0854983,1);
				...
				Decal1.m_DecalBlendAlpha = _DecalBlendAlpha1_Lollipopdark2;
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				if ((1.0 /*_MatcapSmoothnessEnabled*/))
				{
					...
					float matcapSmoothness = (0.725 /*_MatcapSmoothness*/);
					...
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap, _trilinear_repeat, TRANSFORM_TEX(matcapUV, _Matcap), matcapSmoothness) * float4(poiThemeColor(poiMods, float4(1,0.808104,0.9462251,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(1,0.808104,0.9462251,1).a);
				}
				else
				{
					matcap = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap)) * float4(poiThemeColor(poiMods, float4(1,0.808104,0.9462251,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(1,0.808104,0.9462251,1).a);
				}
				#else
				matcap = float4(poiThemeColor(poiMods, float4(1,0.808104,0.9462251,1).rgb, (0.0 /*_MatcapColorThemeIndex*/)), float4(1,0.808104,0.9462251,1).a);
				#endif
				matcapIntensity = (1.17 /*_MatcapIntensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.412 /*_MatcapAdd*/), (0.0 /*_MatcapAddToLight*/), (0.0 /*_MatcapMultiply*/), (0.0 /*_MatcapReplace*/), (0.0 /*_MatcapMixed*/), (0.0 /*_MatcapScreen*/), matcap, matcapMask, (0.0 /*_MatcapEmissionStrength*/), (0.0 /*_MatcapLightMask*/), (0.0 /*_MatcapMaskGlobalMask*/), (2.0 /*_MatcapMaskGlobalMaskBlendType*/), matcapALD);
				#endif
				#ifdef COLOR_GRADING_HDR_3D
				...
				if ((0.0 /*_Matcap2SmoothnessEnabled*/))
				{
					...
					matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER_LOD(_Matcap2, _trilinear_repeat, TRANSFORM_TEX(matcapUV, _Matcap2), matcap2Smoothness) * float4(poiThemeColor(poiMods, float4(0.9943275,0.8465297,1,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0.9943275,0.8465297,1,1).a);
				}
				else
				{
					matcap2 = UNITY_SAMPLE_TEX2D_SAMPLER(_Matcap2, _MainTex, TRANSFORM_TEX(matcapUV, _Matcap2)) * float4(poiThemeColor(poiMods, float4(0.9943275,0.8465297,1,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0.9943275,0.8465297,1,1).a);
				}
				#else
				matcap2 = float4(poiThemeColor(poiMods, float4(0.9943275,0.8465297,1,1).rgb, (0.0 /*_Matcap2ColorThemeIndex*/)), float4(0.9943275,0.8465297,1,1).a);
				#endif
				matcapIntensity = (0.27 /*_Matcap2Intensity*/);
				#ifdef POI_AUDIOLINK
				if (matcapALD.matcapALEnabled > 0)
				{
					matcapIntensity += lerp(matcapALD.matcapALIntensityAdd.x, matcapALD.matcapALIntensityAdd.y, poiMods.audioLink[matcapALD.matcapALIntensityAddBand]);
				...
				matcap2.rgb = lerp(matcap2.rgb, matcap2.rgb * poiFragData.baseColor.rgb, (1.0 /*_Matcap2BaseColorMix*/));
				#if defined(PROP_MATCAP2MASK) || !defined(OPTIMIZER_ENABLED)
				...
				blendMatcap(poiLight, poiFragData, poiMods, (0.467 /*_Matcap2Add*/), (0.0 /*_Matcap2AddToLight*/), (0.0 /*_Matcap2Multiply*/), (0.0 /*_Matcap2Replace*/), (0.0 /*_Matcap2Mixed*/), (0.0 /*_Matcap2Screen*/), matcap2, matcap2Mask, (0.0 /*_Matcap2EmissionStrength*/), (0.0 /*_Matcap2LightMask*/), (0.0 /*_Matcap2MaskGlobalMask*/), (2.0 /*_Matcap2MaskGlobalMaskBlendType*/), matcapALD);
				#endif
			}
			#endif
			...
			void applyGlitter(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, in PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					float2 st = (poiMesh.uv[(0.0 /*_GlitterUV*/)] + float4(0,0,0,0).xy * _Time.x) * (50000.0 /*_GlitterFrequency*/);
					...
					half3 glitterColor = poiThemeColor(poiMods, float4(1,0.4198113,0.7747592,1).rgb, (0.0 /*_GlitterColorThemeIndex*/));
					...
					switch((0.0 /*_GlitterMode*/))
					{
						...
						{
							randomRotation = randomFloat3WiggleRange(randoPoint, (5.5 /*_GlitterAngleRange*/), (0.0 /*_GlitterSpeed*/), glitterSpeedOffset);
						}
						else
						{
							randomRotation = randomFloat3Range(randoPoint, (5.5 /*_GlitterAngleRange*/));
						}
						float3 glitterReflectionDirection = normalize(mul(poiRotationMatrixFromAngles(randomRotation), norm));
						finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(saturate(dot(lerp(glitterReflectionDirection, poiCam.viewDir, (0.187 /*_GlitterBias*/)), poiCam.viewDir)), (561.0 /*_GlitterContrast*/)), 0);
						...
						finalGlitter = lerp(0, (0.0 /*_GlitterMinBrightness*/) * glitterAlpha, glitterAlpha) + max(pow(specAngle, (561.0 /*_GlitterContrast*/)), 0);
					...
					glitterMask *= float4(1,0.4198113,0.7747592,1).a;
			...
			{
				float3 backlightColor = float4(1,0.6313685,0.7668092,1).rgb;
				#if defined(PROP_BACKLIGHTCOLORTEX) || !defined(OPTIMIZER_ENABLED)
				...
				#endif
				backlightLN = poiEdgeLinear(backlightLN, (0.281 /*_BacklightBorder*/), (0.172 /*_BacklightBlur*/));
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(7.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), _BumpScale_Lollipopdark2);
				#else
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.07896989,0.02427682,0.01856302,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.07896989,0.02427682,0.01856302,1).a;
				#ifdef COLOR_GRADING_HDR
				#if defined(PROP_MAINCOLORADJUSTTEXTURE) || !defined(OPTIMIZER_ENABLED)
				...
				{
					float shift = (0.959 /*_MainHueShift*/);
					#ifdef POI_AUDIOLINK
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), - ((-0.25 /*_Saturation*/)) * hueShiftAlpha.b);
				...
				if ((2.0 /*_MainAlphaMaskMode*/))
				{
					...
					alphaMask = saturate(alphaMask * (1.0 /*_AlphaMaskBlendStrength*/) + ((1.0 /*_AlphaMaskInvert*/) ?_AlphaMaskValue * -1 : (0.0 /*_AlphaMaskValue*/)));
				...
				#endif
				ApplyPoiyomiRimLighting(poiFragData, poiMesh, poiCam, poiLight, poiMods, (1.0 /*_Is_NormalMapToRimLight*/), (0.0 /*_RimLightingInvert*/), (1.82 /*_RimPower*/), (0.0 /*_RimStrength*/), (0.0 /*_RimShadowWidth*/), (0.0 /*_RimShadowToggle*/), (0.864 /*_RimWidth*/), (0.799 /*_RimBlendStrength*/), rimMask, (0.0 /*_RimGlobalMask*/), (2.0 /*_RimGlobalMaskBlendType*/), rimColor, float4(0.3359889,0.2563742,0.3456162,1), (0.0 /*_RimLightColorThemeIndex*/), (0.0 /*_RimHueShiftEnabled*/), (0.0 /*_RimHueShift*/), (0.0 /*_RimHueShiftColorSpace*/), (0.0 /*_RimHueShiftSpeed*/),  (0.0 /*_RimSharpness*/), (0.0 /*_RimShadowMaskRampType*/), (0.0 /*_RimShadowMaskInvert*/), (1.0 /*_RimShadowMaskStrength*/), float4(0,0,0,1), (0.0 /*_RimApplyGlobalMaskIndex*/), (2.0 /*_RimApplyGlobalMaskBlendType*/), (0.0 /*_RimBaseColorMix*/), (1.35 /*_RimBrightness*/), (2.0 /*_RimPoiBlendMode*/), AudioLinkRimWidthBand, AudioLinkRimWidthAdd, AudioLinkRimEmissionBand, AudioLinkRimEmissionAdd, AudioLinkRimBrightnessBand, AudioLinkRimBrightnessAdd, rimBias, (0.0 /*_RimBiasIntensity*/), (0 /*_RimApplyAlpha*/), (1.0 /*_RimApplyAlphaBlend*/));
				#endif
				#endif
				#ifdef _SUNDISK_SIMPLE
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyOutlineColor(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiMods poiMods, in PoiCam poiCam)
			{
				...
				float4 outlineColor = float4(0.1579265,0,0,1);
				#ifdef POI_AUDIOLINK
