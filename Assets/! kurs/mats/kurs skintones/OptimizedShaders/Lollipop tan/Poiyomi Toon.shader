Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/ac76ea55e433e6f4ea8dfe72901e99d8"
{
	Properties
	{
		...
		[Normal]_BumpMap ("Normal Map--{reference_properties:[_BumpMapPan, _BumpMapUV, _BumpScale_Lollipoptan, _BumpMapStochastic]}", 2D) = "bump" { }
		...
		[HideInInspector]_BumpScale_Lollipoptan ("Intensity", Range(0, 10)) = 1
		...
		_DecalBlendAlpha1_Lollipoptan ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DecalBlendAlpha1_Lollipoptan;
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal1.m_DecalBlendAlpha = _DecalBlendAlpha1_Lollipoptan;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				#if defined(PROP_BUMPMAP) || !defined(OPTIMIZER_ENABLED)
				poiMesh.tangentSpaceNormal = UnpackScaleNormal(POI2D_SAMPLER_PAN_STOCHASTIC(_BumpMap, _MainTex, poiUV(poiMesh.uv[(7.0 /*_BumpMapUV*/)].xy, float4(1,1,0,0)), float4(0,0,0,0), (0.0 /*_BumpMapStochastic*/)), _BumpScale_Lollipoptan);
				#else
				...
				#endif
				poiFragData.baseColor = mainTexture.rgb * poiThemeColor(poiMods, float4(0.6562665,0.4836102,0.4836102,1).rgb, (0.0 /*_ColorThemeIndex*/));
				poiFragData.alpha = mainTexture.a * float4(0.6562665,0.4836102,0.4836102,1).a;
				#ifdef COLOR_GRADING_HDR
				#if defined(PROP_MAINCOLORADJUSTTEXTURE) || !defined(OPTIMIZER_ENABLED)
