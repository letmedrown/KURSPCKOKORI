Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/6dcc1848658832143adb0b3e23252d8a"
{
	Properties
	{
		...
		_DecalBlendAlpha2_lightface5 ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DecalBlendAlpha2_lightface5;
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal2.m_DecalBlendAlpha = _DecalBlendAlpha2_lightface5;
