Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/55c42f757f5198247aa0d996f7871091"
{
	Properties
	{
		...
		_DecalBlendAlpha2_face2Ddark ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DecalBlendAlpha2_face2Ddark;
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal2.m_DecalBlendAlpha = _DecalBlendAlpha2_face2Ddark;
