Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/a8f66c579cb64ca46b04f6285b16d22b"
{
	Properties
	{
		...
		_DecalBlendAlpha2_facetan2 ("Alpha", Range(0, 1)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _DecalBlendAlpha2_facetan2;
			...
			void applyDecals(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiCam poiCam, inout PoiMods poiMods, in PoiLight poiLight)
			{
				...
				Decal2.m_DecalBlendAlpha = _DecalBlendAlpha2_facetan2;
