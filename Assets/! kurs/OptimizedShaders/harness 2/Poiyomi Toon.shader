Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/0f89bdfe866196741859eff5b41c7d62"
{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void applyMatcap(inout PoiFragData poiFragData, in PoiCam poiCam, in PoiMesh poiMesh, inout PoiLight poiLight, in PoiMods poiMods)
			{
				...
				{
					matcap2.rgb = hueShift(matcap2.rgb, _Matcap2HueShift + _Time.x * (0.0 /*_Matcap2HueShiftSpeed*/));
				}
