Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/093973452898d8e4eb4b62051593fad5"
{
	Properties
	{
 ...
 #define OPTIMIZER_ENABLED 
			...
			void MochieBRDF(inout PoiFragData poiFragData, in PoiCam poiCam, inout PoiLight poiLight, in PoiMesh poiMesh, inout PoiMods poiMods)
			{
				...
				reflections *= poiThemeColor(poiMods, float4(0.5903555,0.05875936,1,1), 0.0);
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(0.02679705,0,1,1).rgb, 0.0);
				poiFragData.alpha = mainTexture.a * float4(0.02679705,0,1,1).a;
				#else
