...
namespace Av3Creator.UIElements
{
    public class TwoPaneSplitView : UnityEngine.UIElements.TwoPaneSplitView
    {
    ...
    //        UxmlIntAttributeDescription m_FixedPaneInitialSize = new UxmlIntAttributeDescription { name = "fixed-pane-initial-size", defaultValue = 200 };
    ...
    //        var ussPath = AssetDatabase.GUIDToAssetPath("f466b96b2a5953a4cba92963b4ac47ee");
